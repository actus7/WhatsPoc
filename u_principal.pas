...
type
  TfrmPrincipal = class(TForm)
    ...
    procedure btnWPoCClick(Sender: TObject);
...
uses
  Datasnap.DBClient, Winapi.ShellAPI, System.AnsiStrings, System.JSON, uMain;
...
procedure TfrmPrincipal.btnWPoCClick(Sender: TObject);
begin
